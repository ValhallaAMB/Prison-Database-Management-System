...
CREATE TABLE `labour` (
  ...
  `labour hours` int DEFAULT NULL,
  `labour type` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `labour` VALUES (1,4,'Construction'),(2,4,'Stone Picking'),(3,3,'Kitchen Duty'),(4,2,'Cleaning');
